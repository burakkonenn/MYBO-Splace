...
{
    public class CreateDesignBackgroundValidator : AbstractValidator<Web.Application.DTOs.Design.DesignBackground.CreateDesignBackground>
    {
        public CreateDesignBackgroundValidator()
        {
            RuleFor(n => n.Title)
               .NotEmpty()
